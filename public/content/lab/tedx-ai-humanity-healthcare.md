Ten years. That's how long it took doctors to find my diagnosis.
...
AI is trained on data. Medical data comes from systems that already exclude people. Women whose pain has been dismissed. Patients from under-documented populations. Conditions that don't match the textbook because the textbook was written without them.

Garbage in, garbage out. But worse: biased data in, confidently wrong algorithm out.

The question isn't whether AI should be in healthcare. It should. The question is: who gets protected when it fails? Who gets left behind when the algorithm is confident and wrong?

That's the thing I'm still sitting with. The thing the room needs to hold.

---

The talk is on YouTube. Watch it. Disagree with it if you want. Tell me where I got it wrong.

**[Watch: Can AI restore humanity in healthcare? | TEDxMedUniGraz](https://www.youtube.com/watch?v=lMkt7d0i3fg)**

The conversation isn't finished. It's barely started.